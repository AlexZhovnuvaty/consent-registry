...
class ConsentPayload(object):
    ...
    def __init__(self, payload):
        self._transaction = consent_payload_pb2.ConsentPayload()
    ...
    def is_request_consent(self):
        return self._transaction.payload_type == \
               consent_payload_pb2.ConsentPayload.PAYLOAD_REQUEST_CONSENT
    ...
    def is_decline_consent(self):
        return self._transaction.payload_type == \
               consent_payload_pb2.ConsentPayload.PAYLOAD_DECLINE_CONSENT
    ...
    def is_approve_consent(self):
        return self._transaction.payload_type == \
               consent_payload_pb2.ConsentPayload.PAYLOAD_APPROVE_CONSENT
    ...
    def is_revoke_consent(self):
        return self._transaction.payload_type == \
               consent_payload_pb2.ConsentPayload.PAYLOAD_REVOKE_CONSENT

    def transaction_type(self):
        return self._transaction.payload_type

    def is_create_client(self):
        return self._transaction.payload_type == consent_payload_pb2.ConsentPayload.PAYLOAD_ADD_CLIENT
